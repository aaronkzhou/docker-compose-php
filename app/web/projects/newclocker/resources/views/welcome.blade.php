...
<html>
    ...
    <body ng-app="TimeTracker" ng-controller="TimeController as vm">
               ...
               <div class="well timeentry" ng-repeat="time in vm.timeentries">
                    <div class="row">
                        ...
                        <div class="col-sm-4 time-numbers">
                            ...
                            <h2>
                                <span class="label label-primary" ng-show="time.loggedTime.duration._data.hours > 0">@{{time.loggedTime.duration._data.hours}} hour
    ...
    <script type="text/javascript" src="js/controller/TimeController.js"></script>
    <script type="text/javascript" src="js/service/TimeService.js"></script> 
